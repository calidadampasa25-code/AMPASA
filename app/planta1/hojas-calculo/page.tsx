...
export default async function HojasCalculoPlanta1() {
  await requireApprovedUser()
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#f1f1f1] p-6">
      <div className="max-w-4xl mx-auto">
        <Link href="/planta1" className="text-[#a1a1aa] hover:text-[#f1f1f1] text-sm">← Volver a Planta 1</Link>
        <h1 className="text-3xl font-semibold mt-4 mb-8">Hojas de Cálculo - Planta 1</h1>
        
        <div className="card p-8">
          <p className="text-[#a1a1aa] mb-6">Aquí puedes subir y ver las hojas de cálculo de Planta 1.</p>
