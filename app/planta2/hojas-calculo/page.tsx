...
export default async function HojasCalculoPlanta2() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#f1f1f1] p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl font-semibold mt-4 mb-8">Hojas de Cálculo - Planta 2</h1>
        
        <div className="card p-8">
          <p className="text-[#a1a1aa] mb-6">Aquí puedes subir y ver las hojas de cálculo de Planta 2.</p>
